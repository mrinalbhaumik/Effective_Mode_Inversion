...
Layer_param.h_count     = [1 2 3];        % If 'h' is 'variable': [LRs: Ex. 1.5 2 3], [LNs: Ex. 4 5... + H.S]; If 'fixed': [LNs] as the number of layers
...
Layer_param.Vs_reversal = 0.01;          % allowable fractional Vs drop (if any)
